...
export default function Navbar() {
  ...
  return (
    <>
      {/* Fixed colour bar */}
      <div className="flag-bar" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50 }} />

      {/* Nav bar */}
      <nav
        style={{
          position: "fixed", top: 3, left: 0, right: 0, zIndex: 49,
      ...
      >
        <Link href="/" style={{ textDecoration: "none", flexShrink: 0 }}>
          <span className="font-bebas" style={{ fontSize: 20, letterSpacing: 3, color: "#C9953A" }}>
            PIB ETO&apos;O{" "}
            <span style={{ color: "rgba(245,240,232,0.3)", fontSize: 13, letterSpacing: 2 }}>
              · MESSINA
            </span>
          </span>
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          <a
            ...
            style={{
              ...
              color: "#080F0D", background: "#C9953A",
        ...
        <button
          ...
          className="lg:hidden text-[#C9953A] border-none p-1 bg-none flex cursor-pointer"
          aria-label="Menu"
        >
