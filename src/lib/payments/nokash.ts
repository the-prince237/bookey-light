...
export const PAYMENT_METHODS: PaymentMethodDef[] = [
  {
    ...
    country: 'CM',
    flag: '🇨🇲',
    requiredFields: ['user_phone'],
    placeholder: { user_phone: '237670000000' },
  },
  {
    method: 'ORANGE_MONEY',
    label: 'Orange Money',
    ...
    flag: '🇨🇲',
    requiredFields: ['user_phone'],
    placeholder: { user_phone: '237690000000' },
  },
  {
    method: 'EUM',
    ...
    flag: '🇨🇲',
    requiredFields: ['user_phone'],
    placeholder: { user_phone: '237650000000' },
  },
  {
    method: 'BANK_TRANSFER',
    label: 'Virement bancaire',
    type: 'NG_BANKTRANSFER',
    country: 'NG',
    flag: '🇳🇬',
    requiredFields: ['user_email', 'user_name', 'user_bank_code', 'user_bank_account'],
    placeholder: {
      user_email: 'payer@email.com',
      user_name: 'Nom Prénom',
      user_bank_code: '033',
      user_bank_account: '0000000000',
    },
  },
]
...
export function errorAdvice(cat: ErrorCategory): string {
  switch (cat) {
    case 'UNKNOWN':
      return 'Une erreur interne est survenue. Ne relancez pas encore — notre équipe vérifie. Contactez le support si le problème persiste.'
    case 'INTERNAL':
