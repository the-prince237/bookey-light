...
const label = (extra = ''): React.CSSProperties => ({
  ...
  gap: 14,
  marginBottom: 20,
  ...(extra === 'mb40' ? { marginBottom: 40 } : {}),
})
const afterLine: React.CSSProperties = {
  flex: 1,
  height: 1,
    ...
    <>
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              'repeating-linear-gradient(-45deg,transparent,transparent 80px,rgba(201,149,58,.03) 80px,rgba(201,149,58,.03) 81px)',
          }}
        />
        <div
          style={{
            ...
            height: 600,
            borderRadius: '50%',
            background: 'radial-gradient(circle,rgba(201,149,58,.1) 0%,transparent 65%)',
            top: '50%',
            right: '-80px',
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 900, width: '100%' }}>
          ...
          <div className="anim-fade-up anim-d2" style={{ marginBottom: 20 }}>
            ...
            <span
              className="font-bebas text-gold-shimmer"
              style={{
            ...
            <span
              ...
              style={{
                fontStyle: 'italic',
                fontSize: 'clamp(16px,2.4vw,25px)',
          ...
          >
            ...
            Pas en buts — en{' '}
            <strong style={{ color: '#E8C06A', fontStyle: 'normal' }}>
              dollars, en investissements, en influence géopolitique.
            </strong>
          </p>
          ...
          <div className="hero-stats anim-fade-up anim-d4">
            {bookData.stats.map((s, i) => (
              <div
                ...
                className="hero-stat"
                style={{
                  borderLeftColor: i === 0 ? 'transparent' : 'rgba(201,149,58,.25)',
                }}
              >
                <span
                  className="font-bebas"
                  style={{ fontSize: 42, color: G, lineHeight: 1, display: 'block' }}
                >
                  {s.num}
                </span>
                <span
      ...
      <section className="py-section px-page" style={{ background: DRK }}>
        <div className="inner grid-problem" style={{ alignItems: 'center' }}>
          <Reveal>
            ...
            >
              &ldquo;Un pays assis sur un gisement pétrolier sans jamais avoir inventé la
              foreuse.&rdquo;
            </p>
          </Reveal>
          <Reveal delay={2}>
            ...
            >
              Qu&apos;est-ce que vaut vraiment Samuel Eto&apos;o pour le Cameroun ? Pas en
              buts, pas en trophées — mais en{' '}
              <strong style={{ color: CRM, fontStyle: 'normal' }}>
                dollars, en investissements, en influence géopolitique.
              </strong>
            </p>
            <p
      ...
      >
        ...
        <div className="inner" style={{ position: 'relative', zIndex: 2 }}>
          <Reveal>
            <p style={label()}>
              La thèse centrale <span style={afterLine} />
            </p>
            <h2
              className="font-bebas"
              style={{
            ...
            >
              ...
              <span style={{ color: G }}>400–700 millions de dollars par an</span> de
              valeur non capturée.
            </h2>
          </Reveal>
          <div className="grid-thesis">
            {[
              {
                n: '01',
                t: 'Un actif de classe mondiale',
                b: 'Quadruple Vainqueur de la Ligue des Champions, triple Vainqueur de la CAN, icône mondiale sur cinq continents et président de la FECAFOOT. Une puissance symbolique que peu de nations peuvent revendiquer.',
              },
              {
                n: '02',
                t: 'Une valeur inexploitée',
                b: "Le Cameroun n'a jamais mis en place les mécanismes permettant de transformer cette puissance en valeur économique tangible. Valeur non capturée estimée à 400–700 millions de dollars par an.",
              },
              {
                n: '03',
                t: 'Le diagnostic',
                b: "En croisant soft power (Joseph Nye), économie de la marque et analyse institutionnelle, l'auteur livre une autopsie intellectuelle d'un phénomène rarissime : un actif soft power de classe mondiale né sur le continent africain.",
              },
              {
                n: '04',
                t: "Le remède : l'EIG",
                b: "L'Eto'o Investment Gateway (EIG) est un blueprint opérationnel hybride public-privé, inspiré des modèles irlandais, rwandais et qatari, adapté aux réalités camerounaises.",
              },
            ].map((c, i) => (
              <Reveal key={i} delay={(i % 2) as 0 | 1 | 2 | 3 | 4}>
                <div style={{ background: 'rgba(11,61,46,.8)', padding: '36px 30px' }}>
                  ...
                  <div
                    className="font-playfair"
                    style={{ fontSize: 17, fontWeight: 700, color: G, marginBottom: 10 }}
                  >
                    {c.t}
                  </div>
                  <p
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              'radial-gradient(ellipse at center,rgba(201,149,58,.06) 0%,transparent 70%)',
          }}
        />
        <Reveal>
          <p
          ...
          >
            ...
            Le soft power n&apos;est pas une question de gentillesse internationale.
            C&apos;est une question de profitabilité stratégique à long terme.
          ...
          <div className="chapter-intro">
            <Reveal>
              ...
              >
                10 Chapitres.
                <br />
                <span style={{ color: G }}>Un Blueprint.</span>
              </h2>
            </Reveal>
            <Reveal delay={2}>
              <p
              ...
              >
                ...
                est une autopsie intellectuelle en dix actes — narrative, rigoureuse, et
                profondément ancrée dans la réalité africaine.
              </p>
            </Reveal>
          </div>
            ...
            {bookData.chapters_list.map((ch, i) => (
              <Reveal key={i} delay={(i % 2) as 0 | 1 | 2 | 3 | 4}>
                <div
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.background = 'rgba(11,61,46,.4)')
                  }
                  onMouseLeave={(e) => (e.currentTarget.style.background = '#0a0f0d')}
                >
                  <span
                    className="font-bebas"
                    style={{ fontSize: 30, color: G, lineHeight: 1, opacity: 0.45 }}
                  >
                    {ch.num}
                  </span>
                  <div>
      ...
      <section className="py-section px-page" style={{ background: DRK }}>
        <div className="inner">
          <Reveal>
            <p style={label('mb40')}>
              Extraits de l&apos;ouvrage <span style={afterLine} />
            </p>
          </Reveal>
      ...
      <section className="py-section px-page" style={{ background: '#050A08' }}>
        <div className="inner">
          <Reveal>
            <p style={label()}>
              Angles de lecture <span style={afterLine} />
            </p>
            <h2
              className="font-bebas"
              style={{
            ...
            {bookData.angles.map((a, i) => (
              <Reveal key={i} delay={(i % 3) as 0 | 1 | 2 | 3 | 4}>
                <div
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderBottomColor = G
                    e.currentTarget.style.background = 'rgba(11,61,46,.25)'
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderBottomColor = 'transparent'
                    e.currentTarget.style.background = '#050A08'
                  }}
                >
                  <span
                    style={{
                  ...
                  <div
                    className="font-playfair"
                    style={{ fontSize: 16, fontWeight: 700, color: CRM, marginBottom: 8 }}
                  >
                    {a.title}
                  </div>
                  <p
      ...
      >
        <div
          style={{
            ...
            height: 500,
            borderRadius: '50%',
            background: 'radial-gradient(circle,rgba(201,149,58,.07) 0%,transparent 70%)',
          }}
        />
        <div className="inner author-grid" style={{ position: 'relative', zIndex: 2 }}>
            ...
            >
              <div
                style={{
                  ...
                  height: 4,
                  background:
                    'linear-gradient(90deg,#007A5E 33%,#CE1126 33%,#CE1126 66%,#FCD116 66%)',
                }}
              />
              <span
                className="font-bebas"
                style={{ fontSize: 72, color: 'rgba(201,149,58,.14)', letterSpacing: 6 }}
              >
                GBM
              </span>
              <span
          ...
          <div>
            ...
            <Reveal delay={2}>
              ...
              >
                Économiste · Analyste de l&apos;Innovation Africaine
              </p>
            </Reveal>
            ...
            <Reveal delay={3}>
              ...
              >
                Économiste, analyste de l&apos;innovation africaine et consultant en
                stratégie de développement.{' '}
                <strong style={{ color: CRM, fontWeight: 600 }}>
                  Spécialiste des dynamiques d&apos;investissement en Afrique
                  subsaharienne
                </strong>
                , il explore depuis quinze ans l&apos;intersection entre capital
                symbolique, diplomatie économique et transformation institutionnelle.
              </p>
            </Reveal>
            <Reveal delay={4}>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {['Économie', 'Diplomatie', 'Innovation', 'Afrique', 'Soft Power'].map(
                  (t) => (
                    <span
                      key={t}
                      style={{
                        ...
                        textTransform: 'uppercase',
                        color: 'rgba(245,240,232,.4)',
                        border: '1px solid rgba(201,149,58,.22)',
                        padding: '5px 12px',
                      }}
                    >
                      {t}
      ...
      <section
        ...
        style={{
          padding: '72px 0',
          background: 'linear-gradient(135deg,#0a0f0d 0%,#0B3D2E 100%)',
          borderTop: '1px solid rgba(201,149,58,.15)',
        }}
      >
        ...
        <div className="inner specs-grid" style={{ position: 'relative', zIndex: 2 }}>
          <div>
            <Reveal>
              ...
              >
                Détails
                <br />
                <span style={{ color: G }}>de l&apos;ouvrage</span>
              </h2>
            </Reveal>
            <Reveal delay={2}>
              {[
          ...
          <Reveal delay={3}>
            ...
            >
              <div
                className="font-bebas"
                style={{ fontSize: 30, letterSpacing: 2, color: CRM }}
              >
              ...
              >
                Disponible en librairie et en édition numérique
              </p>
              <div
                className="font-bebas"
                style={{ fontSize: 50, color: G, lineHeight: 1 }}
              >
                {formatCurrency(bookData.price, bookData.currency)}
              </div>
                ...
                {bookData.languages.map((l) => (
                  <span
                    ...
                    style={{
                      ...
                      letterSpacing: 2,
                      color: G,
                      border: '1px solid rgba(201,149,58,.5)',
                      padding: '3px 12px',
                    }}
                  >
                    {l}
              ...
              <a
                ...
                onMouseLeave={(e) =>
                  (e.currentTarget.style.borderColor = 'rgba(201,149,58,.35)')
                }
              >
                Contacter l&apos;éditeur
              </a>
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              'radial-gradient(ellipse at center bottom,rgba(11,61,46,.4) 0%,transparent 70%)',
          }}
        />
        <div
          className="inner"
        ...
        >
          <Reveal>
            ...
            >
              ...
              <br />
              sur le <span style={{ color: G }}>football.</span>
            </h2>
            <p
              className="font-cormorant"
              style={{
          ...
          <div className="contact-cards">
            {[
              {
                label: 'Email',
                val: bookData.contact.email,
                href: `mailto:${bookData.contact.email}`,
              },
              {
                label: 'Presse',
                val: bookData.contact.press,
                href: `mailto:${bookData.contact.press}`,
              },
              {
                label: 'Téléphone',
                val: bookData.contact.phone,
                href: `tel:${bookData.contact.phone.replace(/\s/g, '')}`,
              },
              {
                label: 'WhatsApp',
                val: bookData.contact.phone,
                href: `https://wa.me/${bookData.contact.whatsapp}`,
              },
          ...
          <Reveal delay={2}>
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 10px 40px rgba(201,149,58,.4)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'none'
